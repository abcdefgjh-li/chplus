...
定义(字符串) 读取文件前N行(定义(字符串) filename, 定义(整型) n) {
    ...
    // 使用系统命令读取前N行
    系统命令行("echo 读取文件 " + filename + " 的前 " + 整数转字符串(n) + " 行:");
    系统命令行("for /l %i in (1,1," + 整数转字符串(n) + ") do @findstr /n \"^\" " + filename + " | find \"^" + 整数转字符串(n) + "^\"");
    返回 "文件 " + filename + " 的前 " + 整数转字符串(n) + " 行内容已显示";
}
...
定义(字符串) 读取文件第N行(定义(字符串) filename, 定义(整型) line_number) {
    ...
    // 使用系统命令读取指定行
    系统命令行("echo 读取文件 " + filename + " 的第 " + 整数转字符串(line_number) + " 行:");
    系统命令行("more +" + 整数转字符串(line_number - 1) + " " + filename);
    返回 "文件 " + filename + " 的第 " + 整数转字符串(line_number) + " 行内容已显示";
}
